...
public class MultilayerNeuralNetworkExampleOnIrisDataset {
    ...
    public static void main(String[] args) {
        ...
        var dataset = dataProcessor.loadDataSetFromCSV(CSV_FILE, ',', SKIP_HEAD, featureColumnIndices, targetColumnIndex);
        dataset.shuffle();
        dataset.normalize();
        ...
        var networkConfiguration = new NetworkConfiguration(trainFeatures[0].length, List.of(128, 256, 512), 3, 0.01, 300, ActivationFunction.LEAKY_RELU, ActivationFunction.SOFTMAX, LossFunction.CATEGORICAL_CROSS_ENTROPY, Initialization.XAVIER, Initialization.XAVIER);
