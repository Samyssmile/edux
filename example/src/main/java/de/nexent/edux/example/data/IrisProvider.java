package de.nexent.edux.example.data;

import de.nexent.edux.data.provider.IDataProvider;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import java.util.List;

import static de.nexent.edux.example.data.IrisDataUtil.loadIrisDataSet;
