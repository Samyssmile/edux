...
import de.edux.ml.api.core.network.Engine;
...
import de.edux.ml.api.core.network.loss.LossFunctions;
import de.edux.ml.api.core.network.optimizer.Approximator;
...
public class NeuralNetTest {
  ...
  void testWeightGradient() {
    ...
    Matrix approximatedWeightGradients =
        Approximator.weightGradient(
            weights,
            in -> {
  ...
  void testEngineLayerbased() {
    ...
    // Loss function
    Matrix approximatedError =
        Approximator.gradient(
            input,
            in -> {
