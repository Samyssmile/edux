...
public class ActivationFunctionTest {
  ...
  public void testSigmoid() {
    ...
    Assertions.assertEquals(
        expectedActivation, ActivationFunction.SIGMOID.calculateActivation(input), DELTA);
  ...
  public void testLeakyRelu() {
    ...
    assertEquals(
        inputPositive, ActivationFunction.LEAKY_RELU.calculateActivation(inputPositive), DELTA);
    assertEquals(
        0.01 * inputNegative,
        ActivationFunction.LEAKY_RELU.calculateActivation(inputNegative),
        DELTA);
