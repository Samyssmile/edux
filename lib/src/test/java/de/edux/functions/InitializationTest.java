...
public class InitializationTest {
    ...
    public void testXavierInitialization() {
        ...
        for (double weight : weights) {
            assertTrue(weight >= -xavier && weight <= xavier, "Weight should be in the range of Xavier initialization");
        }
    }
    ...
    public void testHeInitialization() {
        ...
        for (double weight : weights) {
            assertTrue(weight >= -he && weight <= he, "Weight should be in the range of He initialization");
        }
    }
}
