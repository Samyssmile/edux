 ...
 *
 * <p>This implementation utilizes a backpropagation algorithm for training the neural network to
 ...
 *
 * <p>The training process adjusts the weights and biases of neurons within the network based on the
 ...
 * </pre>
 *
 * <p>Note: This implementation logs informative messages, such as accuracy per epoch, using SLF4J
 * logging.
 *
...
public class MultilayerPerceptron implements Classifier {
  ...
  private void updateWeights(
      ...
      List<double[]> hidden_error_signals,
      double[][] features) {
